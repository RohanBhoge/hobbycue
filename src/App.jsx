  ...
  <div className="container mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex justify-between items-center mb-4">
      <h2 className="text-3xl md:text-4xl font-bold text-black">
        Your <span className="text-purple-600">Hobby</span>, Your <span className="text-blue-500">Community...</span>
      </h2>
    ...
    <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
      <img src={Community_1} alt="Community_1" className="w-full h-auto" />
      <img src={Community_2} alt="Community_2" className="w-full h-auto" />
    </div>
  </div>
</section>
